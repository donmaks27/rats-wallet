CREATE TABLE users(id INTEGER PRIMARY KEY NOT NULL, name TEXT, create_date INTEGER NOT NULL);
CREATE TABLE currencies(code TEXT NOT NULL PRIMARY KEY, name TEXT, is_active INTEGER NOT NULL, create_date INTEGER NOT NULL);
CREATE TABLE labels(
    id INTEGER PRIMARY KEY, user_id INTEGER, name TEXT, is_active INTEGER NOT NULL, create_date INTEGER NOT NULL,
    FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE
);
CREATE TABLE categories(
    id INTEGER PRIMARY KEY, user_id INTEGER, parent_id INTEGER, name TEXT, is_active INTEGER NOT NULL, create_date INTEGER NOT NULL,
    FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (parent_id) REFERENCES categories(id) ON UPDATE CASCADE ON DELETE SET NULL
);
CREATE TABLE accounts(
    id INTEGER PRIMARY KEY, user_id INTEGER NOT NULL, currency_code TEXT NOT NULL, name TEXT, start_amount INTEGER NOT NULL, is_active INTEGER NOT NULL, create_date INTEGER NOT NULL,
    FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
